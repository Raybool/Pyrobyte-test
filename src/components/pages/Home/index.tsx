...
import { DigitalWork } from '@/components/atoms/icons/DigitalWork';
import { Payment } from '@/components/atoms/icons/Payment';
    ...
    <div className={styles.container}>
      ...
      <main className={styles.mainContainer}>
        ...
        <div className={styles.mainBox}>
          <div className={styles.rightBox}>
            ...
            <div className={styles.yellowBox}>
              ...
              <InputSearch isTwoV placeholder="Enter code" />
            </div>
          </div>
        ...
        <div className={styles.sliderContainer}>
          ...
          <Slider
            data={sliderData}
            spaceBetween={windowWidth > 360 ? 80 : 16}
            slidesPerView={windowWidth > 360 ? 5 : 3}
        ...
        <div className={styles.sliderPaymentContainer}>
          ...
          <Slider
            ...
            spaceBetween={windowWidth > 360 ? 104 : 64}
            slidesPerView={windowWidth > 360 ? 6 : 3}
            sliderElementType="default"
            navigation={windowWidth > 360 && true}
          />
        </div>
        ...
        <div className={styles.whiteTextContainer}>
          <p>
            ...
            <ShowMoreButton onClick={console.log} />
          </p>
        </div>
      </main>
